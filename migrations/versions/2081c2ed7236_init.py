...
Revision ID: 2081c2ed7236
Revises: 
Create Date: 2023-11-20 13:48:02.142542
...
def upgrade() -> None:
    ...
    sa.Column('image_transformed_url', sa.String(), nullable=True),
    ...
    op.create_table('image_m2m_tags',
    sa.Column('id', sa.Integer(), nullable=False),
